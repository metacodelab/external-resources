...
void TCS34725::writeReg (uint8_t reg, uint32_t value) {
...
uint8_t TCS34725::readReg(uint8_t reg) {
...
uint16_t TCS34725::readRegWord(uint8_t reg) {
...
boolean TCS34725::begin(tcs34725IntegrationTime_t it, tcs34725Gain_t gain) {
	...
	free(gammatable);//debug jh 20.9.11 tello
...
void TCS34725::getRGBC (uint16_t *r, uint16_t *g, uint16_t *b, uint16_t *c, bool wait) {
