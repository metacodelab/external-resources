...
#define IO_REG_BASE_ATTR
#define IO_REG_MASK_ATTR
#define DIRECT_READ(base, pin)          digitalRead1(pin)
#define DIRECT_WRITE_LOW(base, pin)     digitalWrite1(pin, LOW)
#define DIRECT_WRITE_HIGH(base, pin)    digitalWrite1(pin, HIGH)
#define DIRECT_MODE_INPUT(base, pin)    pinMode1(pin,INPUT)
#define DIRECT_MODE_OUTPUT(base, pin)   pinMode1(pin,OUTPUT)
