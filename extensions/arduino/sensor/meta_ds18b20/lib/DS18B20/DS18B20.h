...
// extern uint8_t myinsideThermometer[8];
...
public:
    ...
    float getTempC(const uint8_t* deviceAddress = NULL);

    // returns temperature in degrees F
    float getTempF(const uint8_t* deviceAddress = NULL);
...
private:
    uint8_t *myinsideThermometer = NULL;
