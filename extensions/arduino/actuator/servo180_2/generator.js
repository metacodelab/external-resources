...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.servo180_setState_0 = function (block) {
        ...
        Blockly.Arduino.definitions_[`servo180_setState_${pin}`] =`MetaCodeServo servo_${pin};`;
        Blockly.Arduino.setups_[`servo180_setState_${pin}`] =`servo_${pin}.attach(${pin});`;

        return `servo_${pin}.setAngle_180(${degree});\n`;
    };
    ...
    Blockly.Arduino.servo180_setState_90 = function (block) {
        ...
        return `servo_${pin}.angle_180(abs(${degree}));\n`;
    };
