...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        WS2812B_INIT: '初始化 RGB灯 引脚 %1 灯总数 %2',
        WS2812B_SETBRIGHTNESS: 'RGB灯 设置引脚 %1 灯带亮度为 %2',
        WS2812B_CLEAR: 'RGB灯 引脚 %1 全部熄灭',
        WS2812B_SETRANGECOLOR: 'RGB灯 引脚 %1 灯号 %2 到 %3 显示颜色 %4',
        WS2812B_RGBTOCOLOR: '红 %1 绿 %2 蓝 %3',
        WS2812B_SHOWRAINBOW: 'RGB灯 引脚 %1 灯号 %2 到 %3 显示渐变颜色 色调从 %4 到 %5',
        WS2812B_SHIFT: 'RGB灯 引脚 %1 移动 %2 单位',
        WS2812B_ROTATE: 'RGB灯 引脚 %1 循环移动 %2 单位',
        WS2812B_SHOWBARGRAPH: 'RGB灯 引脚 %1 灯号 %2 到 %3 显示柱状图 当前值 %4 最大值 %5',
    });
    return Blockly;
}
